...
info_url = 'http://myhorizon.solorient.com.au/Horizon/logonGuest.aw?domain=horizondap_cowra'
comment_url = 'mailto:council@cowra.nsw.gov.au'
...
xml.xpath('//run_query_action_return/run_query_action_success/dataset/row').each do |app|
  record = {
      ...
      'address'           => (app.xpath('Property').attribute('org_value').text + ' NSW').strip,
